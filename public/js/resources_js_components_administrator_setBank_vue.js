  ...
  methods: {
    getClients: function getClients() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/getClients", send).then(function (res) {
        self.clients = res.data.map(function (_ref) {
          var id = _ref.id,
              inn = _ref.inn,
