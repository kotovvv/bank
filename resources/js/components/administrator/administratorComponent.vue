  ...
  <v-app id="inspire">
    <v-app-bar app>
      <svg
        ...
        y="0px"
        viewBox="0 0 379 462"
        style="enable-background: new 0 0 379 462; width: 38px"
        xml:space="preserve"
      >
        <path
          d="M258,232.6c31.4-20.9,45.1-42.5,62.8-90c6.6-17.7,11.5-37.3,15.2-57.5c1.4-7.8,2.7-20,9.8-18
        ...
        />
        <path
          d="M177.3,218.6c16.6,16.6,21.2,29.2,30.6,50.5c10.7,24.3,37.2,99.3,71,93.1c8.1-1.5,17.1-7.7,24.5-11.7
		c-5.3,8.6-7,11.8-16.2,17c-56.4,31.6-94-103.8-123-130.3c-5.1-3.6-6.3-10.7-2.7-15.8C165.1,216.3,172.2,215,177.3,218.6z"
        />
        <path
          d="M233.2,232.6c-32.9-20.9-47.3-42.5-65.9-90c-6.9-17.7-12.1-37.3-15.9-57.5c-1.5-7.8-2.8-20-10.2-18
        ...
        />
        <path
          d="M170.8,227.9c44.9-25.9,91-72,76.4-128.6C229.6,31.2,140.5,28.5,95.1,75.9c-76.7,80-58.6,286.2,43.4,340.2
...
const operators = () => import("../admin/operators");
...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { text: "Операторы", name: "operators", icon: "mdi-phone-log-outline" },
      { text: "Справочник", name: "users", icon: "mdi-account-multiple" },
  ...
  computed: {
    managerComponent() {
      ...
      if (this.managerMenu == "operators") return operators;
